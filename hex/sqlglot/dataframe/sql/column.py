...
from hex.sqlglot.dataframe.sql.types import DataType
from hex.sqlglot.helper import flatten, is_iterable

if t.TYPE_CHECKING:
    from hex.sqlglot.dataframe.sql._typing import ColumnOrLiteral
    from hex.sqlglot.dataframe.sql.window import WindowSpec
...
class Column:
    ...
    def when(self, condition: Column, value: t.Any) -> Column:
        from hex.sqlglot.dataframe.sql.functions import when
