...
from hex.sqlglot.errors import ErrorLevel, ParseError, concat_messages, merge_errors
from hex.sqlglot.helper import apply_index_offset, ensure_list, seq_get
from hex.sqlglot.time import format_time
from hex.sqlglot.tokens import Token, Tokenizer, TokenType
from hex.sqlglot.trie import TrieResult, in_trie, new_trie

if t.TYPE_CHECKING:
    from hex.sqlglot._typing import E, Lit
    from hex.sqlglot.dialects.dialect import Dialect, DialectType
...
class Parser(metaclass=_Parser):
    ...
    def _implicit_unnests_to_explicit(self, this: E) -> E:
        from hex.sqlglot.optimizer.normalize_identifiers import normalize_identifiers as _norm
