...
from hex.sqlglot.optimizer.normalize import normalized
from hex.sqlglot.optimizer.scope import build_scope, find_in_scope
from hex.sqlglot.optimizer.simplify import simplify
from hex.sqlglot import Dialect
