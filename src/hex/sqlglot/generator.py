...
from hex.sqlglot.errors import ErrorLevel, UnsupportedError, concat_messages
from hex.sqlglot.helper import apply_index_offset, csv, name_sequence, seq_get
from hex.sqlglot.jsonpath import ALL_JSON_PATH_PARTS, JSON_PATH_PART_TRANSFORMS
...
class Generator(metaclass=_Generator):
    ...
    def preprocess(self, expression: exp.Expression) -> exp.Expression:
        ...
        if self.ENSURE_BOOLS:
            from hex.sqlglot.transforms import ensure_bools
    ...
    def _move_ctes_to_top_level(self, expression: E) -> E:
        if (
            ...
            from hex.sqlglot.transforms import move_ctes_to_top_level
    ...
    def extract_sql(self, expression: exp.Extract) -> str:
        from hex.sqlglot.dialects.dialect import map_date_part
    ...
    def dateadd_sql(self, expression: exp.DateAdd) -> str:
        from hex.sqlglot.dialects.dialect import unit_to_str
